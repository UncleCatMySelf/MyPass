 ...
 * @QQ:1341933031
 * @Date:Created in 17:13 2018\8\23 0023
 */
@Slf4j
@Service
public class IUserServiceImpl implements IUserService {
    ...
    @Autowired
    public IUserServiceImpl(HbaseTemplate hbaseTemplate,StringRedisTemplate redisTemplate) {
    ...
    public Response createUser(User user) throws Exception {
        ...
        byte[] FAMILY_B = Constants.UserTable.FAMTLY_B.getBytes();
